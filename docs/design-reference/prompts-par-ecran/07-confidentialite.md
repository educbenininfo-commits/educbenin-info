...
(au moins la section « Fondations de design » + la section « 7. Politique de
confidentialité »), et regarde les captures qu'elle référence dans
docs/design-reference/screenshots/ (fichiers 27, 28).
...
Ensuite, implémente l'écran Politique de confidentialité (page publique) en suivant ce
document à la lettre : mêmes couleurs (valeurs hexadécimales exactes), mêmes polices,
