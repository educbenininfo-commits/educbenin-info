...
(au moins la section « Fondations de design » + la section « 9. Tableau de bord »), et
...
Ensuite, implémente l'écran Tableau de bord (back-office) en suivant ce document à la
lettre : mêmes couleurs (valeurs hexadécimales exactes), mêmes polices, même structure de
layout (y compris le regroupement des deux blocs de KPI et leur réordonnancement en
